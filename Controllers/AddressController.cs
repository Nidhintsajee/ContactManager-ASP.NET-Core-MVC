...
namespace MvcContact.Controllers
{
    public class AddressController : Controller
    {
        ...
        public AddressController(MvcContactContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AddressID,HouseName,City,PinCode")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressID,HouseName,City,PinCode")] Address address)
        {
